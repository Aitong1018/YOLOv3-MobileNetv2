...
def create_modules(module_defs):
    ...
    for module_i, module_def in enumerate(module_defs):
        ...
        if module_def["type"] == "convolutional":
            ...
            pre_pad = int(module_def["pre_padding"])

            if pre_pad:
                modules.add_module(f"pre_pad_{module_i}", nn.ZeroPad2d((1, 1, 1, 1)))
            ...
            if module_def["activation"] == "leaky":
                ...
                modules.add_module(f"relu6_{module_i}", nn.ReLU6(inplace=True))
